/**
 * DesignCanvas — side-by-side grid layout for variations
 *
 * Use to display 2+ static design variations for the user to compare and choose.
 * Each variation has a label and can be hovered to zoom in.
 *
 * Usage:
 *   <DesignCanvas
 *     title="Hero-area design exploration"
 *     subtitle="3-direction comparison"
 *     columns={3}
 *   >
 *     <Variation label="Minimal" description="minimalist, restrained version">
 *       <div>...your design 1...</div>
 *     </Variation>
 *     <Variation label="Editorial" description="editorial magazine style">
 ...
 *   </DesignCanvas>
 *
 * Use with React+Babel. Place in the appropriate script tag; then window.DesignCanvas / window.Variation are available.
 */
