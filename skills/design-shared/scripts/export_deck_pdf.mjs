 ...
 *   - Backgrounds / graphics rendered 1:1 (Playwright's embedded Chromium)
 *   - No HTML modifications required
 *   - Zero visual loss (it's exactly what the browser prints)
 *
 * Trade-off:
 *   - Text in the PDF is no longer editable (edit the HTML and re-export)
 *
