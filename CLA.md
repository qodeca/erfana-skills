...
This Contributor License Agreement ("Agreement") is between you ("Contributor") and **Qodeca sp. z o.o.** ("Qodeca", the project steward). It applies to any contribution you submit to the erfana project.
