...
└── docs/
    ...
    └── gates/               ← 18 per-gate detail files (v4.1.3+: 01-cjk.md … 15-doc-claims.md; v4.2.9+ adds 16-hook-fixtures.md; v6.0.0 adds 17-publication-readiness.md; unreleased adds 18-skill-registry.md)
```
